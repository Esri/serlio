...
void appendToMaterialScriptBuilder(MELScriptBuilder& sb, const MaterialInfo& matInfo,
	...
	if (matInfo.getTexturePath(MaterialInfo::TextureSemantic::COLOR).empty()) {
		...
		createMapShader(sb, matInfo.getTexturePath(MaterialInfo::TextureSemantic::COLOR), matInfo.getTextureTrafo(MaterialInfo::TextureSemantic::COLOR), shaderName, L"map1", false, false);
	...
	if (matInfo.getTexturePath(MaterialInfo::TextureSemantic::BUMP).empty()) {
		...
		createMapShader(sb, matInfo.getTexturePath(MaterialInfo::TextureSemantic::BUMP), matInfo.getTextureTrafo(MaterialInfo::TextureSemantic::BUMP), shaderName, L"bumpMap", true, false);
	...
	if (matInfo.getTexturePath(MaterialInfo::TextureSemantic::DIRT).empty()) {
		...
		createMapShader(sb, matInfo.getTexturePath(MaterialInfo::TextureSemantic::DIRT), matInfo.getTextureTrafo(MaterialInfo::TextureSemantic::DIRT), shaderName, L"dirtMap", false, false);
	...
	if (matInfo.getTexturePath(MaterialInfo::TextureSemantic::SPECULAR).empty()) {
		...
		createMapShader(sb, matInfo.getTexturePath(MaterialInfo::TextureSemantic::SPECULAR), matInfo.getTextureTrafo(MaterialInfo::TextureSemantic::SPECULAR), shaderName, L"specularMap", false, false);
	...
	if (matInfo.getTexturePath(MaterialInfo::TextureSemantic::OPACITY).empty()) {
		...
		createMapShader(sb, matInfo.getTexturePath(MaterialInfo::TextureSemantic::OPACITY), matInfo.getTextureTrafo(MaterialInfo::TextureSemantic::OPACITY), shaderName, L"opacityMap", false, true);
	...
	if (!matInfo.getTexturePath(MaterialInfo::TextureSemantic::NORMAL).empty()) {
		...
		createMapShader(sb, matInfo.getTexturePath(MaterialInfo::TextureSemantic::NORMAL), matInfo.getTextureTrafo(MaterialInfo::TextureSemantic::NORMAL), shaderName, L"normalMap", true, false);
	...
	if (matInfo.getTexturePath(MaterialInfo::TextureSemantic::EMISSIVE).empty()) {
		...
		createMapShader(sb, matInfo.getTexturePath(MaterialInfo::TextureSemantic::EMISSIVE), matInfo.getTextureTrafo(MaterialInfo::TextureSemantic::EMISSIVE), shaderName, L"emissiveMap", false, false);
	...
	if (matInfo.getTexturePath(MaterialInfo::TextureSemantic::ROUGHNESS).empty()) {
		...
		createMapShader(sb, matInfo.getTexturePath(MaterialInfo::TextureSemantic::ROUGHNESS), matInfo.getTextureTrafo(MaterialInfo::TextureSemantic::ROUGHNESS), shaderName, L"roughnessMap", true, false);
	...
	if (matInfo.getTexturePath(MaterialInfo::TextureSemantic::METALLIC).empty()) {
		...
		createMapShader(sb, matInfo.getTexturePath(MaterialInfo::TextureSemantic::METALLIC), matInfo.getTextureTrafo(MaterialInfo::TextureSemantic::METALLIC), shaderName, L"metallicMap", true, false);
